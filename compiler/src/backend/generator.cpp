    ...
    struct StmtVisitor
    {
        ...
        void operator()(VariableStmt var_stmt)
        {
            if (!existing_vars.contains(var_stmt.m_name) &&
                !existing_arrs.contains(var_stmt.m_name) &&
            ...
            {
                m_gen.gen_error("Container exists elwhere or use of reserved keyword as identifier");
            }
        }

        void operator()(ArrayStmt arr_stmt)
        {
            if (!existing_arrs.contains(arr_stmt.m_name) &&
                !existing_vars.contains(arr_stmt.m_name))
            {
            ...
            {
                m_gen.gen_error("Container exists elwhere");
            }
        }
        ...
        {
            if (label_stmt.m_name.at(0) == '_' &&
                label_stmt.m_name.at(1) == '_')
            {
            ...
            {
                m_gen.gen_error("Label exists elwhere");
            }
        }
        ...
        void operator()(ElStmt el_stmt)
        {
            m_gen.gen_scope(*el_stmt.m_body);
        }
    };
